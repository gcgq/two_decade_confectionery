...
class Order(model.Models):
    ...
    billing_address = models.ForeignKey(UserAddress, null = True,
        related_name = "billing_address")
    shipping_address = models.ForeignKey(UserAddress, null = True,
        related_name = "shipping_address")
    shipping_total_price = models.DecimalField(max_digits = 10,
...
def on_order_save(sender, instance, *args, **kwargs):
    shipping_total_price = instance.shipping_total_price
    cart_total = instance.cart.total
    order_total = Decimal(shipping_total_price) + Decimal(cart_total)
    instance.order_total = order_total

pre_save.connect(on_order_save, sender=Order)
