...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0006_auto_20170827_2101'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tax_percentage', models.DecimalField(decimal_places=2, default=0.0, max_digits=9)),
                ('tax_total', models.DecimalField(decimal_places=2, default=0.0, max_digits=9)),
